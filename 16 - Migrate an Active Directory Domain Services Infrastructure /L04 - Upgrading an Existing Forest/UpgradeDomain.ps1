...
Invoke-Command -ComputerName dc.corp.awesome.com -ScriptBlock {Uninstall-ADDSDomainController -DemoteOperationMasterRole -RemoveApplicationPartition -IgnoreLastDNSServerForZone}
