...
mkdir "C:\PS"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/clintbonnett-acg/az-801-testing/main/L03/Demo%20Environment/adusersetup.ps1" -OutFile "C:\PS\adusersetup.ps1"
